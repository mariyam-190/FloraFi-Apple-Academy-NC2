...
struct plant11: View {
                    ...
                    VStack{
                        ...
                        HStack(alignment:.center){
                            ...
                            VStack(alignment:.leading){
                                ...
                                Text("يبدأ من شهر أكتوبر الى شهر أبريل")
                                    .font(.subheadline)
                                    .foregroundColor(.white)
                                    .accessibilityLabel("يبدأ من شهر أكتوبر الى شهر أبريل")
                        ...
                        HStack(alignment:.center){
                            ...
                            VStack(alignment:.leading){
                                ...
                                Text(" لا تتحمل درجات الحرارة العالية")
                                    .font(.subheadline)
                                    .foregroundColor(.white)
                                    .accessibilityLabel(" لاتتحمل درجات الحرارة العالية")
                            }
                        }.padding(.leading,20)//Hs
                        .frame(maxWidth: .infinity, alignment: .leading)
                        //5
    ...
    struct plant11_Previews: PreviewProvider {
        static var previews: some View {
            plant11().environment(\.layoutDirection, .rightToLeft)
        }
    }
