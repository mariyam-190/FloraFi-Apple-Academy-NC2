...
struct plant10: View {
        ...
        VStack{
                VStack{
                    Text("زراعة الملوخية")
                        ...
                        .accessibilityLabel("زراعة الملوخية")
                    Image("نعناع")
                        .resizable()
                        .frame(width: 250 , height: 250)
     
                
                Text("زراعة الملوخية هي عملية بسيطة ويمكن إجراؤها في الحدائق المنزلية أو الأحواض عن طريق البذور.تتحمل درجات الحرارة العالية يُفضل زراعتها في تربة غنية بالمواد العضوية وجيدة التصريف")
                    .font(.system(size: 22))
                    .foregroundColor(Color.C1)
                    .multilineTextAlignment(.center)
                    .padding(20)
                    .bold()
                    .accessibilityLabel("زراعة الملوخية هي عملية بسيطة ويمكن إجراؤها في الحدائق المنزلية أو الأحواض عن طريق البذور.تتحمل درجات الحرارة العالية يُفضل زراعتها في تربة غنية بالمواد العضوية وجيدة التصريف")
                    ...
                    VStack{
                        ...
                        HStack(alignment:.center){
                            ...
                            VStack(alignment:.leading){
                                ...
                                Text("يبدأ من شهر فبراير الى شهر سبتمبر")
                                    .font(.subheadline)
                                    .foregroundColor(.white)
                                    .accessibilityLabel("يبدأ من شهر فبراير الى شهر أبريل")
                        ...
                        HStack(alignment:.center){
                            ...
                            VStack(alignment:.leading){
                                ...
                                Text(" ري منتظم ليبقى الجذور رطبة.")
                                    .font(.subheadline)
                                    .foregroundColor(.white)
                                    .accessibilityLabel(" ري منتظم ليبقى الجذور رطبة.")
                            }
                        }.padding(.leading,20)//Hs
                        .frame(maxWidth: .infinity, alignment: .leading)
                        ...
                        HStack(alignment:.center){
                            ...
                            VStack(alignment:.leading){
                                ...
                                Text(" تتحمل درجات الحرارة العالية")
                                    .font(.subheadline)
                                    .foregroundColor(.white)
                                    .accessibilityLabel(" تتحمل درجات الحرارة العالية")
                            }
                        }.padding(.leading,20)//Hs
                        .frame(maxWidth: .infinity, alignment: .leading)
                        //5
    ...
    struct plant10_Previews: PreviewProvider {
        static var previews: some View {
            plant10().environment(\.layoutDirection, .rightToLeft)
        }
    }
